        ...
        children: [
              ...
              children: [
                  ...
                  child: TextField(
                    ...
                    onChanged: (password) {
                      widget._registerBloc
                          .add(RegisterEventPasswordChanged(password));
                    },
                    style: TextStyle(
                      color: Colors.white,
                    ),
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    onChanged: (password) {
                      widget._registerBloc
                          .add(RegisterEventConfirmPasswordChanged(password));
                    },
                    style: TextStyle(
                      color: Colors.white,
                    ),
          ...
          BlocBuilder<RegisterBloc, RegisterBlocState>(
            ...
            if (state is RegisterBlocStatePasswordandConfirmPasswordValid) {
              return register_button(widget._registerBloc,
                  MediaQuery.of(context).size.width, true);
            }
            return register_button(
                widget._registerBloc, MediaQuery.of(context).size.width, false);
          }),
        ],
      ),
    );
